...
export default function Services() {
  return (
    <div className=" my-24 md:px-6">
      <section className="mx-auto mb-32  max-w-screen-xl py-4 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
        ...
        <div className="flex flex-wrap items-stretch">
          <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-6 lg:mb-0 lg:w-5/12">
            <div
              className="relative h-full overflow-hidden rounded-lg bg-cover bg-[50%] bg-no-repeat shadow-lg dark:shadow-black/60"
              data-te-ripple-init
              ...
              />
              <a href="#!">
                <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-[hsl(0,0%,0%,0.4)] bg-fixed">
          ...
          <div className="w-full shrink-0 grow-0 basis-auto md:px-6 lg:w-7/12">
            <div className="mb-12 flex">
              <div className="shrink-0">
                <div className="rounded-md bg-[hsl(204,30%,20%)] p-4 shadow-lg dark:bg-[rgb(17,24,39)]">
                  <svg
              ...
              <div className="ml-4 grow">
                <p className="mb-1 font-bold">Poultry</p>
            ...
            <div className="mb-12 flex">
              ...
              <div className="ml-4 grow">
                <p className="mb-1 font-bold">POULTRY EQUIPMENTS</p>
                <p className="text-white-100">
            ...
            <div className="mb-12 flex">
              ...
              <div className="ml-4 grow">
                <p className="mb-1 font-bold"> FRESH CHICKEN</p>
                <p className="text-white-100 ">
                  Indulge in the finest, farm-fresh chicken for tender,
                  flavorful meals that will satisfy your taste buds and elevate
            ...
            <div className="flex">
              ...
              <div className="ml-4 grow">
                <p className="mb-1 font-bold">CHICKS</p>
                <p className="text-white-100 ">
